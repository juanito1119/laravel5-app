...
@section('content')
  ...
  <div class="col-lg-12 text-right">
    <a href="{{ url('pagination/create') }}" class="btn btn-action">Crear </a>
  </div>
          ...
          @foreach( $data as $item )
            <tr>
              ...
              <td class="text-center">
                <a href="{{ url('pagination/update/'.$item->id)}}"><i class="fa fa-pencil"></i></a>
                <a href="{{ url('pagination/delete/'.$item->id)}}" data-confirm-title="Eliminar" data-confirm-content="Desea eliminar el código {{ $item->id }}"><i class="fa fa-trash"></i></a>
              </td>
            </tr>
          @endforeach
        @endif
