...
@section('content')
  ...
  <div class="col-lg-12 text-right">
    <a href="{{ url('priority/create') }}" class="btn btn-action">Crear </a>
  </div>
          ...
          @foreach( $data as $item )
            <tr>
              ...
              <td class="text-center">
                <a href="{{ url('priority/update/'.$item->id)}}"><i class="fa fa-pencil"></i></a>
                <a href="{{ url('priority/delete/'.$item->id)}}" data-confirm-title="Eliminar" data-confirm-content="Desea eliminar el código {{ $item->id }}"><i class="fa fa-trash"></i></a>
              </td>
            </tr>
          @endforeach
        @endif
